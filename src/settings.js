...
var Prefs = class Prefs {
  constructor() {
    ...
    this.CPU_TEMP_HWMON_NUMBER = new PrefValue(settings, 'cpu-temp-hwmon-number', 'int');
    this.FAN_SPEED_HWMON_NUMBER = new PrefValue(settings, 'fan-speed-hwmon-number', 'int');
